...
[![Codecov test coverage](https://codecov.io/gh/LucyMcGowan/sve/graph/badge.svg)](https://app.codecov.io/gh/LucyMcGowan/sve)
<!-- badges: end -->
...
By default, confidence intervals are calculated using the profile likelihood method. To calculate Wald-type intervals on a transformed scale and then back-transformed in order to ensure that they remain between -1 and 1 use `method = "tanh-wald"`. If you do not want to use this transformation, you can set the option `method = "wald"`:
